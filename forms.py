...
class LoginForm(forms.ModelForm):
    username = forms.RegexField(max_length = 10,
            regex=r'^[1-9][0-9]{9}')
...
class RegisterForm(forms.ModelForm):
    ...
    email =
    forms.RegexField(regex=r'^[1-9][0-9]{9}@daiict.ac.in')
    password1 = forms.CharField(widgets =
            forms.PasswordInput)
    password2 = forms.CharField(widgets =
            forms.PasswordInput)
    class Meta:
        model = User
        fields = ("username",)
    ...
    def clean_password(self):
        try:
            ...
            raise forms.validationError(_("The two
